...
public class FulcrumSetupActivity extends ArgosBaseActivity {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if (rec != null && rec.getServiceUuids() != null) {
                ...
                for (int i = 0; i < serviceIds.size(); i++) {
                    ...
                    if (i < cutoff) {
                        if (!quad.equals(argosIds[i])) return;
                    } else {
                        sb.append(quad);
                    }
                }
    ...
    private class PairFulcrumTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String data) {
            ...
            Intent huePair = new Intent(FulcrumSetupActivity.this, HuePairActivity.class);

            startActivity(huePair);
        }
    }
}
