    ...
    public void onMessageReceived(RemoteMessage rm) {
        ...
        try {
            ...
            NotificationCompat.Builder notBuilder = new NotificationCompat.Builder(this)
                    .setSmallIcon(R.mipmap.argos_logo)
...
//            SQLiteDatabase notDatabase = openOrCreateDatabase("ArgosDB",MODE_PRIVATE,null);
//            notDatabase.execSQL("INSERT INTO Notification (DeviceName, DeviceId, FulcrumId, DesiredState) " +
//                    "VALUES('" + deviceName +"','" + deviceId + "', '" + fulcrumId + "', '" + desiredState + "');");
