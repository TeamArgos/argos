...
var defaultConfig = __dirname + path.sep + "defaults.json";
var config = require(defaultConfig);
var userConfigDir = `${os.homedir()}${path.sep}${config.local_directory}`;
var userConfig = `${userConfigDir}${path.sep}settings.json`;
